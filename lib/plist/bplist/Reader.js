...
const UID_UINT32_SIZE = UINT32_SIZE + 1;
const INT64_SIZE = NumberSizes.int64.bytes;
const UID_INT64_SIZE = INT64_SIZE + 1;
...
class Reader {
	...
	constructor(buffer) {
		...
		this.__integerReaders = {
			...
			[UID_UINT32_SIZE]:	this.__buffer.readUInt32BE.bind(this.__buffer),
			[INT64_SIZE]:	this.__buffer.readInt64BE.bind(this.__buffer),
			[UID_INT64_SIZE]:	this.__buffer.readInt64BE.bind(this.__buffer),
		};
	}
